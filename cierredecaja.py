...
class CierreDeCajaFrame(ttk.Frame):
    ...
    def __init__(self, parent, current_user=None):
        ...
        ttk.Button(btns_top, text="Hoy", command=self._preset_hoy).pack(side="left", padx=(0,6))
        ttk.Button(btns_top, text="Calcular automático", command=self._auto_calc).pack(side="left")
